...
<br />
<a
  class="b-1 w-fit af-i-ph-arrow-right  fw-500  rd-xl b-accentA-6  dark:b-accentA-7 c-prm11 bg-gradient-to-r from-prm1 to-sand1  active:(b-accentA-8 from-prm5 to-sand2) hover:b-accentA-7 hover:from-prm2 hover:to-prm1 )  focus-visible:b-accentA-8 focus-visible:from-prm4 focus-visible:to-prm2  bg-origin-border  c-prm11  fw-500 py-4 b-1.5  px-8 rd-xl flex gap-2 ac  !my-20 "
  href="https://momenta.app"
  target="_blank"
>
  Visit Momenta
</a>
...
<a
  class="b-1 w-fit af-i-ph-arrow-right  fw-500  rd-xl b-accentA-6  dark:b-accentA-7 c-prm11 bg-gradient-to-r from-prm1 to-sand1  active:(b-accentA-8 from-prm5 to-sand2) hover:b-accentA-7 hover:from-prm2 hover:to-prm1 )  focus-visible:b-accentA-8 focus-visible:from-prm4 focus-visible:to-prm2  bg-origin-border  c-prm11  fw-500 py-4 b-1.5  px-8 rd-xl flex gap-2 ac  !mt-20 "
  href="https://momenta.app"
  target="_blank"
>
  Visit Momenta
