...
export default function Noise({opacity = '0.12', frequancy= '1.2', numOctaves = '6' , style = {} , className = ""}) {
  return (
    <div
      style={{
        backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg' width='200px' height='200px'  %3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='${frequancy}' numOctaves='${numOctaves}' stitchTiles='stitch' /%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)' /%3E%3C/svg%3E")`,
