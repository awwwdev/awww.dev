...
export default function Search({  value, onChange, placeholder }){
  return (
    <div className="px-2 py-1.5 rd-lg  b-1 b-sand5 bg-sand1  w-full fw-400 min-w-40 max-w-80 flex-1 text-base flex items-center gap-2 focus-within:outline-brand-orange focus-within:outline-1px focus-within:outline-solid">
