    ...
    <div className="flex flex-wrap justify-end ac gap-8 c-gray9">
      <div className="flex gap-2 ac ">
        ...
        <select
          ...
          className="px-1 py-1 rd-2 bg-gray1 block c-prm10 b-1 b-prm10"
        >
      ...
      <div className="flex ac gap-2 ">
        ...
        >
          <Icon name="i-ph-arrow-line-left" className="inline-block w-1em h-1em c-prm10" />
        </button>
        <button
          className="b-1 fw-500 px-4 py-1 rd-lg b-prm7 c-sand11 active:(b-prm8 bg-gray1) hover:(b-prm10  bg-gray1)  focus:(b-prm10  bg-gray1) disabled:(!c-gray9 !bg-prm3 !b-prm5)"
          ...
          disabled={!table.getCanPreviousPage()}
        >
          <Icon name="i-ph-arrow-left" className="inline-block w-1em h-1em c-prm10" />
        </button>
        <p className="flex ac gap-2">
          ...
          <input
            ...
            className="field inline c-prm10"
            size={3}
          />{" "}
        ...
        >
          <Icon name="i-ph-arrow-right" className="inline-block w-1em h-1em c-prm10" />
        </button>
        <button
          className="b-1 fw-500 px-4 py-1 rd-lg b-prm7 c-sand11 active:(b-prm8 bg-gray1) hover:(b-prm10  bg-gray1)  focus:(b-prm10  bg-gray1) disabled:(!c-gray9 !bg-prm3 !b-prm5)"
          ...
          disabled={!table.getCanNextPage()}
        >
          <Icon name="i-ph-arrow-line-right" className="inline-block w-1em h-1e c-prm10" />
        </button>
      </div>
      <div className="flex gap-2 ac ">
        <span className="c-gray9">{table.getPrePaginationRowModel().rows.length} Rows</span>
