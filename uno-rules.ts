...
export const shortcuts: Shortcut[] = [
  {
    ...
    "btn-ghost-prm":
      " b-1   fw-500 px-4 py-1 rd-lg b-prm7 c-prm11 active:b-prm11 active:bg-prm1 hover:b-prm9 hover:bg-prm1 focus:b-prm9 focus:bg-prm1 disabled:btn-disabled",
    "btn-ghost":
    ...
    H1: "fs-3xl sm:fs-4xl fw-700 ls-tightest",
    H2: "fs-2xl sm:fs-3xl fw-700 ls-tighter",
    H3: "fs-xl sm:fs-2xl fw-500 ls-tighter",
    H4: "fs-lg sm:fs-xl fw-500  ls-tight",
