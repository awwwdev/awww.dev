...
const Archived = () => {
  ...
  const mailQ = useQuery({
    queryKey: ["introMeetingPayerDash-2"],
    queryFn: async () => {
  ...
  const handleArchive = async (mailId) => {
    ...
    if (error) {
      ...
      queryClient.invalidateQueries(["introMeetingPayerDash-2"]);
  ...
  return (
    <>
      <div className="flex justify-between items-center">
        ...
        <Link href="/payer-dashboard/inbox/intro-meeting" className="btn-ghost-accent">
